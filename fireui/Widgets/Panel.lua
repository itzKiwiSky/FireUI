...
local function new(_options)
    ...
    self.draw = _options.draw or function()
        love.graphics.setColor(fireui.theme.state.active.background[1] / 255, fireui.theme.state.active.background[2] / 255, fireui.theme.state.active.background[3] / 255)
